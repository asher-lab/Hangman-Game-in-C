...
int main ()
{
	...
	Declarations
	************/
	THE_ALL_REPEATER_SHORTCUT:{printf("\n");}
	...
	//Results of the Game.
		...
		if(wrongTry>0){
			...
			scanf("%s", say);
			if(strcmp(say,"yes")==0){
			rewinder=0;battery=0;clear;goto THE_ALL_REPEATER_SHORTCUT;} //if yes then repeat hangman game program since rewinder =1 and battery 0.
				else if (strcmp(say,"no")==0){
				rewinder=0;battery=0;} // if no then stop the program.
					else battery=1;
					} // end of while
   ...
   choice2:
    	{
				...
				randomizer;
				char words[e][8]={"cat", "dog", "cow", "rainbow", "water", "apple", "love", "cotton", "camel", "cloud"};
			    int f;
			    f=rand()%10;
